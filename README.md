...
### Adding New Features
1. **Additional Features**: Modify `model.py` to include more input features (bedrooms, location, etc.)
2. **Different Algorithms**: Experiment with other regression algorithms
3. **Model Improvements**: Add feature engineering, cross-validation
4. **Enhanced UI**: Add charts, graphs, or comparison tools
...
- [ ] Multiple input features (bedrooms, bathrooms, location)
